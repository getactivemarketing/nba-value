...
import { NFLPicks } from '@/pages/NFLPicks';
import { NFLEvaluation } from '@/pages/NFLEvaluation';
  ...
  return (
    <Layout>
      <Routes>
        ...
        <Route path="/nfl" element={<NFLPicks />} />
        <Route path="/nfl/performance" element={<NFLEvaluation />} />
